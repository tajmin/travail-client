            ...
            <Grid container spacing={1}  style={{ marginTop:'10px'}}>
                ...
                <Grid item md={12} lg={6} style={{ textAlign:'left'}}>
                    ...
                    <Grid>
                        ...
                        <Typography sx={{ color: '#2196f3;', pl:1, display:'inline', fontSize: 30}}>jobshub@gmail.com</Typography>
                    </Grid>
                    <Grid>
                        <FacebookIcon sx={{color:'#2979ff', fontSize:30}}></FacebookIcon>
                        <Typography sx={{ color: '#2979ff;', pl:1, display:'inline', fontSize: 30}}>www.facebook.com/jobshub</Typography>
                    </Grid>
                    <Grid>
                        <LinkedInIcon sx={{color:'rgb(0, 119, 181)', mx:1, fontSize:30, ml:-.1}}></LinkedInIcon>
                        <Typography sx={{ color: 'rgb(0, 119, 181)', pl:1, display:'inline', fontSize: 30}}>www.linkedln.com/jobshub</Typography>
                    </Grid>
                    <Grid>
                        <TwitterIcon sx={{color:'rgb(56, 161, 243)', fontSize:30}}></TwitterIcon>
                        <Typography sx={{ color: 'rgb(56, 161, 243)', pl:1, display:'inline', fontSize: 30}}>www.twitter.com/jobshub</Typography>
                    </Grid>
                </Grid>
            </Grid>
            <Footer></Footer>
